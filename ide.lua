------------------------------------------------------------------------------
-- Modify from https://github.com/joysfera/nodemcu-web-ide/blob/master/ide.lua
...
local function editor(aceEnabled)
  -- feel free to disable the shiny Ajax.org Cloud Editor
    ...
    conn:on("receive", function(sck, payload)
      ...
      if vars == "edit" then
        if AceEnabled then
          ...
          if url:match(".css") then
            mode = mode .. 'css'
          elseif url:match(".html") then
            mode = mode .. 'html'
          elseif url:match(".json") then
            mode = mode .. 'json'
          elseif url:match(".js") then
      ...
      if url == "" then
        ...
        for k, v in pairs(l) do
          ...
          line = line .. "</td><td><a href='#' onclick='this.href=\"/" .. k .. "?delete\"; return true;'>delete</a></td><td>"
